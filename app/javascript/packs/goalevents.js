...
const goallocation = (event) => {
	...
	document.getElementById("goal_goalevents_attributes_0_enddepth").value=goallocationonpitch.toFixed(1);
	document.getElementById("goal_goalevents_attributes_0_endwidth").value=0;
